...
public class MyScanner {
    ...
    public void scan(){
        ...
        FiniteAutomaton FA_Integer_Constants = new FiniteAutomaton("IO/FA_Integer_Constant.txt");
        FiniteAutomaton FA_Identifier = new FiniteAutomaton("IO/FA_Identifier.txt");
        ...
        for(Couple<String, Couple<Integer,Integer>> t: tokens)
        {
            ...
            else if(FA_Integer_Constants.acceptsSequence(token))
            {
                //If the token is an integer, Old Regex: "^0|[-|+]?[1-9][0-9]*"
            ...
            else if(FA_Identifier.acceptsSequence(token))
            {
                //If the token is an Identifier, Old regex: "^[a-zA-Z][a-zA-Z0-9]*"
